...
// Create satellite title layer (map background)
...
// Create the earthquake and tectonic plate layers for the map
let earthquakes = new L.LayerGroup();
let plates = new L.LayerGroup();

//define object that contains the overlay
let overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
    ...
    L.geoJson(data, {
        ...
        style: styleInfo, getColor, getRadius,
